...
**Count: 34 tasks. Budget 38. Headroom 4.** (was 30/34/4; D-026 split the content model into five tasks and raised the budget by the same +4, so the reserve is unchanged — the increase was not spent on itself.)
```
